...
@InputType()
class InteractionCreateNestedManyWithoutChatbotsInput {
...
export { InteractionCreateNestedManyWithoutChatbotsInput as InteractionCreateNestedManyWithoutChatbotsInput };
