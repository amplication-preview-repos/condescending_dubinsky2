...
export class ResponseResolverBase {
  ...
  async getRfp(@graphql.Parent() parent: Response): Promise<Rfp | null> {
    const result = await this.service.getRfp(parent.id);
